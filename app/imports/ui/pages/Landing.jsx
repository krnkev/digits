    ...
    return (
        ...
        <Grid container centered stackable columns={3}>
          ...
          <Grid.Column textAlign = 'center'>
              ...
              <Header as='h3' inverted>This address book allows any number of users to
                  register and save their business contacts. You can only see
              the contacts you have created.</Header>
          </Grid.Column>
            ...
            <Grid.Column textAlign = 'center'>
                ...
                <Header as='h3' inverted>Each time you make contact wit ha contact,
                    you can write a note that summarizes the conversation. This note
                    is saved along with a timestamp and the contact. </Header>
            </Grid.Column>
