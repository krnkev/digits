...
class EditContact extends React.Component {
  ...
  submit(data) {
    const { firstName, lastName, description, address, image, _id } = data;
    Contacts.collection.update(_id, { $set: { firstName, lastName, description, address, image } }, (error) => (error ?
